...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(
            150,125, width=280, text='q', fill=THEME_COLOR, 
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"The End. Your score is {self.quiz.score}/10")
